...
public:
    ...
    Q_PROPERTY(QObject* geoserverSettings               READ geoserverSettings              CONSTANT)
    ...
    GeoserverSettings*              geoserverSettings           (void) { return _geoserverSettings;}
#if !defined(NO_ARDUPILOT_DIALECT)
...
private:
    ...
    GeoserverSettings*              _geoserverSettings;
#if !defined(NO_ARDUPILOT_DIALECT)
