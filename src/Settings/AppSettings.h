...
public:
    ...
    DEFINE_SETTINGFACT(superUserUnlocked)
    ...
    Q_PROPERTY(QString profileDirectorySavePath        READ profileDirectorySavePath      NOTIFY savePathsChanged)
    ...
    QString profileDirectorySavePath();
