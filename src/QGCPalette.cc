...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#1e90ff", "#3a3a3a", "#fff291")
    ...
    DECLARE_QGC_COLOR(mapButtonHighlight,   "#585858", "#1e90ff", "#585858", "#1e90ff")
    DECLARE_QGC_COLOR(mapIndicator,         "#585858", "#1e90ff", "#585858", "#1e90ff")
    DECLARE_QGC_COLOR(mapIndicatorChild,    "#585858", "#1e90ff", "#585858", "#1e90ff")
    ...
    //                                              Disabled    Enabled
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple,     "#1e90ff", "#1e90ff")
    ...
    DECLARE_QGC_SINGLE_COLOR(mapMissionTrajectory,          "#1e90ff")
