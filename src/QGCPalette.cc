...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#3402bf", "#3a3a3a", "#fff291")
    ...
    DECLARE_QGC_COLOR(mapButtonHighlight,   "#585858", "#3402bf", "#585858", "#3402bf")
    DECLARE_QGC_COLOR(mapIndicator,         "#585858", "#3402bf", "#585858", "#3402bf")
    DECLARE_QGC_COLOR(mapIndicatorChild,    "#585858", "#3402bf", "#585858", "#3402bf")
    ...
    //                                              Disabled    Enabled
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple,     "#3402bf", "#3402bf")
    ...
    DECLARE_QGC_SINGLE_COLOR(mapMissionTrajectory,          "#3402bf")
